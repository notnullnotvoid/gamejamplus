...
static inline Coord2 coord2(Vec2 v) { return { (int) lroundf(v.x), (int) lroundf(v.y)                                         }; }
static inline Coord3 coord2(Vec3 v) { return { (int) lroundf(v.x), (int) lroundf(v.y), (int) lroundf(v.z)                     }; }
static inline Coord4 coord2(Vec4 v) { return { (int) lroundf(v.x), (int) lroundf(v.y), (int) lroundf(v.z), (int) lroundf(v.w) }; }
